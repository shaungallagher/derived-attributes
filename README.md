...
For an example of how to use Derived Attributes in a real-world scenario, see [examples](https://github.com/shaungallagher/derived-attributes/tree/main/examples).
